...
export default function Investments() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
        <div>
          <h2 className="text-2xl font-bold font-headline text-on-surface tracking-tight">Investment Portfolio</h2>
        ...
        {!activeAddress ? (
          <div className="bg-on-surface/5 backdrop-blur-xl border border-on-surface/10 shadow-[0_4px_20px_rgba(0,0,0,0.2)] rounded-xl p-12 text-center">
            ...
            <p className="text-sm text-on-surface/40 font-body mt-1">Connect your Pera Wallet to see your investments.</p>
          </div>
        ) : (
          <>
            {/* Stat cards */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-on-surface/5 backdrop-blur-xl border border-on-surface/10 shadow-[0_4px_20px_rgba(0,0,0,0.2)] rounded-xl p-5">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-xs text-on-surface/40 font-body">ALGO Portfolio</p>
                  <span className="material-symbols-outlined text-xl text-[#2962FF]">account_balance</span>
                </div>
                <p className="text-xl font-bold font-headline text-on-surface tracking-tight">{balanceLoading ? '…' : inr(inrBalance)}</p>
                <p className="text-xs text-on-surface/40 font-body mt-1">{algoBalance.toFixed(4)} ALGO</p>
              </div>
              <div className="bg-on-surface/5 backdrop-blur-xl border border-on-surface/10 shadow-[0_4px_20px_rgba(0,0,0,0.2)] rounded-xl p-5">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-xs text-on-surface/40 font-body">Active Predictions</p>
                  <span className="material-symbols-outlined text-xl text-[#00FFA3]">casino</span>
                </div>
                <p className="text-xl font-bold font-headline text-on-surface tracking-tight">{inr(totalWageredINR)}</p>
                <p className="text-xs text-on-surface/40 font-body mt-1">{activePositions.length} positions</p>
              </div>
              <div className="bg-on-surface/5 backdrop-blur-xl border border-on-surface/10 shadow-[0_4px_20px_rgba(0,0,0,0.2)] rounded-xl p-5">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-xs text-on-surface/40 font-body">Potential Returns</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-on-surface/5 backdrop-blur-xl border border-on-surface/10 shadow-[0_4px_20px_rgba(0,0,0,0.2)] rounded-xl p-5">
                <h3 className="font-bold font-headline text-on-surface tracking-tight mb-4">Portfolio Split (Donut)</h3>
                {portfolioSegments.length > 0 ? (
                  ...
                  <p className="text-sm text-on-surface/40 font-body text-center py-8">No portfolio data.</p>
                )}
              </div>

              <div className="bg-on-surface/5 backdrop-blur-xl border border-on-surface/10 shadow-[0_4px_20px_rgba(0,0,0,0.2)] rounded-xl p-5 space-y-4">
                <h3 className="font-bold font-headline text-on-surface tracking-tight">Investment Details</h3>

                {/* ALGO Holdings block */}
                <div className="flex items-start gap-4 p-4 bg-[#1F2630] rounded-xl border border-on-surface/10">
                  ...
                  <div className="flex-1">
                    <h4 className="text-base font-semibold text-on-surface">ALGO Holdings</h4>
                    ...
                    <div className="grid grid-cols-2 gap-3 mt-3">
                      <div><p className="text-xs text-on-surface/40 font-body">Balance</p><p className="text-sm font-bold font-headline text-on-surface tracking-tight">{algoBalance.toFixed(4)} ALGO</p></div>
                      <div><p className="text-xs text-on-surface/40 font-body">INR Value</p><p className="text-sm font-bold font-headline text-on-surface tracking-tight">{inr(inrBalance)}</p></div>
                      <div><p className="text-xs text-on-surface/40 font-body">Rate</p><p className="text-sm font-bold text-[#2962FF]">₹{ALGO_TO_INR.toLocaleString()}/ALGO</p></div>
                      <div><p className="text-xs text-on-surface/40 font-body">Network</p><p className="text-sm font-bold font-headline text-on-surface tracking-tight">Algorand</p></div>
                    </div>
                    <div className="mt-3">
                      <DonutChart
                        size={88}
                ...
                {activePositions.length > 0 && (
                  <div className="flex items-start gap-4 p-4 bg-[#1F2630] rounded-xl border border-on-surface/10">
                    ...
                    <div>
                      <h4 className="text-base font-semibold text-on-surface">Prediction Markets</h4>
                      ...
                      <div className="grid grid-cols-2 gap-3 mt-3">
                        <div><p className="text-xs text-on-surface/40 font-body">Wagered</p><p className="text-sm font-bold font-headline text-on-surface tracking-tight">{inr(totalWageredINR)}</p></div>
                        <div><p className="text-xs text-on-surface/40 font-body">Potential</p><p className="text-sm font-bold text-[#00FFA3]">{inr(totalPotentialINR)}</p></div>
                      </div>
                    </div>
                  </div>
                )}
